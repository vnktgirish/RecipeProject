...
import recipe.spring.pkg.converters.UnitOfMeasureCommandToUnitOfMeasure;
...
public class IngredientServiceImplTest {
    ...
    public void findByRecipeIdAndReceipeIdHappyPath() throws Exception {
        ...
        //then
        IngredientCommand ingredientCommand = ingredientService.findByIdAndIngredientId(1L, 3L);
